...
const App = (props) => {
    ...
    useEffect(() => {
        glide.current = new Glide(".blessedlife_episodes_tab_list", {
            perView: perView,
            bound: true,
            dragThreshold: false,
    ...
    return (
        <>
            ...
            <section className="blessedlife_episodes_section">
                ...
                <div className="glide_section">
                    ...
                    <div className="blessedlife_episodes_tab_list">
                        <div className="glide__track" data-glide-el="track">
                            <div className="glide__slides">
                                {
                                    group.tabList.map((element, index) => {
                                        return (
                                            <button className={`glide__slide ${getListBtnFocus(index)}`} onClick={(event) => listBtnClickHandler(event, index)} title={`${element.season_name}(${element.secondary_mark})`} key={index}>{`${element.season_name}(${element.secondary_mark})`}</button>
                                        );
                                    })
                                }
                            </div>
                ...
                <div className="blessedlife_episodes_tab_pane">
                    {   
                        (() => {
